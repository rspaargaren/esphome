...
from esphome.components import light, uart, output
from esphome.const import CONF_COMPONENT_ID, CONF_PAGE_ID, CONF_ID, CONF_OUTPUT_ID
...
CONFIG_SCHEMA = light.BRIGHTNESS_ONLY_LIGHT_SCHEMA.extend({
    cv.GenerateID(): cv.declare_id(NextionLightDummy),
